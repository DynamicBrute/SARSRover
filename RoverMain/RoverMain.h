...
typedef enum {WAIT_FOR_TARGET, WAIT_FOR_LOC_UPDATE, IN_TRANSIT, ACCELERATING, DECELERATING,
				OBST_AVOID, OBJ_RETR, ORIENT_TO_TARGET, RETURN_HOME, HOLD} ROVER_STATE;
